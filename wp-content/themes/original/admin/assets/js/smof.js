...
jQuery(document).ready(function($){
	...
	//Masked Inputs (skins as radio buttons)
	$('.of-radio-skin-img').click(function(){
		var color = $(this).data('color');
		var bgcolor = $(this).data('bgcolor');
		var bgimg = $(this).data('bgimg');
		
		$(this).parent().parent().find('.of-radio-skin-img').removeClass('of-radio-skin-selected');
		...
		$('#section-body_background .wp-color-result').css('background-color', '#' + bgcolor);
		$('#section-body_background .of-color').val('#' + bgcolor);
		
		$('#section-custom_bg').find('.of-radio-tile-img').removeClass('of-radio-tile-selected');
		$('#tile-'+bgimg).trigger( "click" );
		
	});
	$('.of-radio-skin-label').hide();
	$('.of-radio-skin-img').show();
	$('.of-radio-skin-radio').hide();
