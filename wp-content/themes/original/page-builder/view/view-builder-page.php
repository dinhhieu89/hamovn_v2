...
<div class="wrap">
	...
	<div id="page-builder-frame">
		<div id="page-builder-section" class="<?php echo $disabled ?>">
			<div id="page-builder-archive">
				<span id="removing-block"><?php _e('Deleting', 'framework') ?></span>
                <div class="inside">
		...
		<div id="page-builder-fixed">
						...
						<div id="aqpb-body">
							...
							<ul class="blocks cf" id="blocks-to-edit">
								...
								if($selected_template_id === 0) {
									...
									echo __('To create a custom page template, give it a name above and click Create Template. Then choose blocks like text, widgets or tabs &amp; toggles from the left section to add to this template.
									<br/><br/>
						...
						<div id="aqpb-footer">
							<div class="major-publishing-actions cf">
								<div class="publishing-action">
                                    ...
                                    <?php submit_button( empty( $selected_template_id ) ? __( 'Create Template', 'framework' ) : __( 'Save Template', 'framework' ), 'pagebuilder-submit ', 'save_template', false, array( 'id' => 'save_template_header' ) ); ?>
			...
			<p style="float:left"><small>Powered by <a href="http://www.presslayer.com" target="_blank">PressLayer</a> - base on <a href="https://github.com/syamilmj/Aqua-Page-Builder" target="_blank" rel="nofollow">AQPB</a></small></p>
